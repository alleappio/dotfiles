#!/bin/bash
set -g @nord_black "#2E3440"
set -g @nord_blue "#5E81AC"
set -g @nord_yellow "#EBCB8B"
set -g @nord_red "#BF616A"
set -g @nord_white "#ECEFF4"
set -g @nord_green "#A3BE8C"
set -g @nord_visual_grey "#4C566A"
set -g @nord_comment_grey "#4C566A"
...
set-window-option -g window-status-current-style bg='#{@nord_blue}',fg='#{@nord_black}' # fg=bg1
...
# bell
set-window-option -g window-status-bell-style bg='#{@nord_red}',fg='#{@nord_black}' # bg=red, fg=bg
